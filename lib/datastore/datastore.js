(function (exports) {
  ...
  Datastore.prototype.updateDocumentByOperations = function (lowlaId, version, updateOps) {
    var datastore = this;
    var deferred = _prom.defer();
  ...
  Datastore.prototype.removeDocument = function (lowlaId) {
    var datastore = this;
    var deferred = _prom.defer();
    datastore.config.db.collection(lowlaId.collectionName, function (err, collection) {
      if (err) {
        ...
        var deferred = _prom.defer();
          datastore.findInCollection(collectionName, {}).then(function (cursor) {
            ...
            stream.on('data', function(doc) {
              ...
              docHandler.write(lowlaId, doc, deleted);
              ++cnt;
            });
          });
