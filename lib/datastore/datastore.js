(function (exports) {
  ...
  Datastore.prototype.updateDocumentByOperations = function (collectionName, id, version, updateOps, options) {
    var datastore = this;
    var deferred = _prom.defer();
    datastore.config.db.collection(collectionName, function (err, collection) {
      if (err) {
  ...
  Datastore.prototype.removeDocument = function (collectionName, id, options) {
    var datastore = this;
    var deferred = _prom.defer();
    datastore.config.db.collection(collectionName, function (err, collection) {
      if (err) {
  ...
  Datastore.prototype.getDocument = function (collectionName, id, options) {
    var datastore = this;
    var deferred = _prom.defer();
    datastore.config.db.collection(collectionName, function (err, collection) {
      if (err) {
      ...
      collection.findOne({_id:id}, function (err, doc) {  //todo options
        if (err) {
          return deferred.reject(err);
        }
        deferred.resolve(doc);
